...
<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0,user-scalable=yes" ksc="MOZILLA/5.0 (LINUX; ANDROID 6.0; NEXUS 5 BUILD/MRA58N) APPLEWEBKIT/537.36 (KHTML, LIKE GECKO) CHROME/93.0.4577.82 MOBILE SAFARI/537.36">

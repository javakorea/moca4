...
public class PDFConverter {
    ...
    public Map convertJPGFileToPDFFile(String jpgsFolderPath, String resultFilePath) throws Exception {
        Map re = new HashMap();
        System.out.println("convertJPGFileToPDFFile : begin");
        ...
        try {
            ...
            //for (int i=0; i<fileCount; i++) {
                File oneFile = new File(resultFilePath+".jpg");
                System.out.println("oneFile.getCanonicalPath->"+oneFile.getCanonicalPath());
                re.put("image", oneFile.getCanonicalPath());
...
//                    contentStream.drawImage(pdImage, 0, 0);
            ...
            File resultFile = new File(resultFilePath+".pdf");
            System.out.println("1>>"+resultFile.getAbsolutePath());
            System.out.println(">resultFile.exists()>"+resultFile.exists());
            if (resultFile.exists()) {
                resultFile.delete();
            }
            
            String motherFolderPath = getMotherFolderPath(resultFile);
            System.out.println(">motherFolderPath>"+motherFolderPath);
            ...
            re.put("pdf", resultFile.getAbsolutePath());
        } catch (Exception e) {
            throw e;

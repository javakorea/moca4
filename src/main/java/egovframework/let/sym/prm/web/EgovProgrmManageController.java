...
public class EgovProgrmManageController {
	...
	@RequestMapping(value = "/sym/prm/EgovProgramListManageSelect_json.do")
	public View EgovProgramListManageSelect_json(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model,
			@RequestParam Map <String, Object> mocaMap) throws Exception {
		...
		searchVO.setSearchKeyword((String)map.get("searchKeyword"));
		model.addAttribute("list", progrmManageService.selectProgrmList(searchVO));
    ...
    @RequestMapping(value="/sym/prm/EgovProgrmManageListModify_json.do")
	public View EgovProgrmManageListModify_json (
    	...
    	for(int i=0;i < list.size() ;i++) {
        	...
        	if("D".equalsIgnoreCase(U.getStatus(row)) ) {
        		...
        		progrmManageVO.setProgrmFileNm((String)row.get("progrmFileNm"));
        		progrmManageService.deleteProgrm(progrmManageVO);
        	}
    	}
    	for(int i=0;i < list.size() ;i++) {
    		...
    		ProgrmManageVO progrmManageVO = new ProgrmManageVO();
    		progrmManageVO.setProgrmFileNm((String)row.get("progrmFileNm"));
    		progrmManageVO.setProgrmKoreanNm((String)row.get("progrmKoreanNm"));
    		progrmManageVO.setProgrmStrePath((String)row.get("progrmStrePath"));
    		progrmManageVO.setProgrmDc((String)row.get("progrmDc"));
    		progrmManageVO.setURL((String)row.get("url"));

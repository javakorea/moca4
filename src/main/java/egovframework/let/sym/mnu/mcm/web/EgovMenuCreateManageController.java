...
public class EgovMenuCreateManageController {
	...
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatSelect_json.do")
	public View EgovMenuCreatSelect_json(
			@RequestParam Map <String, Object> commandMap,
			ModelMap model) throws Exception {
		try {
			Map bodyMap = U.getBody(commandMap);
			String authorCode = (String)bodyMap.get("authorCode");
			MenuCreatVO menuCreatVO = new MenuCreatVO();
			menuCreatVO.setAuthorCode(authorCode);
			model.addAttribute("list", menuCreateManageService.selectMenuCreatList(menuCreatVO));
		}catch(Exception e) {
			e.printStackTrace();
		}
		return jsonview;
	...
	@RequestMapping("/sym/mnu/mcm/EgovMenuCreatInsert_json.do")
	public View EgovMenuCreatInsert_json(
		...
		menuCreateManageService.insertMenuCreatList(bodyMap);
		resultMsg = egovMessageSource.getMessage("success.common.insert");

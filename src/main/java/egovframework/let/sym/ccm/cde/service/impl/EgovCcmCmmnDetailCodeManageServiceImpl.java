...
public class EgovCcmCmmnDetailCodeManageServiceImpl extends EgovAbstractServiceImpl implements EgovCcmCmmnDetailCodeManageService {
	...
	public void deleteCmmnDetailCodePhysic(CmmnDetailCode cmmnDetailCode) throws Exception {
		cmmnDetailCodeManageDAO.deleteCmmnDetailCodePhysic(cmmnDetailCode);
	}
	...
	public List<?> selectCmmnDetailCodeListAdmin(CmmnDetailCodeVO searchVO) throws Exception {
        return cmmnDetailCodeManageDAO.selectCmmnDetailCodeListAdmin(searchVO);
	}
	/**
	 * 공통상세코드 총 갯수를 조회한다.
	 */
	...
	public int selectCmmnDetailCodeListAdminTotCnt(CmmnDetailCodeVO searchVO) throws Exception {
        return cmmnDetailCodeManageDAO.selectCmmnDetailCodeListAdminTotCnt(searchVO);
	}
	/**
	 * 공통상세코드를 수정한다.
	 */

...
public class CmmnDetailCodeManageDAO extends EgovAbstractDAO {
	...
	public void deleteCmmnDetailCodePhysic(CmmnDetailCode cmmnDetailCode) throws Exception {
		delete("CmmnDetailCodeManageDAO.deleteCmmnDetailCodePhysic", cmmnDetailCode);
	}
	...
	public List<?> selectCmmnDetailCodeListAdmin(CmmnDetailCodeVO searchVO) throws Exception {
        return list("CmmnDetailCodeManageDAO.selectCmmnDetailCodeListAdmin", searchVO);
    }
    /**
	 * 공통상세코드 총 갯수를 조회한다.
     * @param searchVO
    ...
    public int selectCmmnDetailCodeListAdminTotCnt(CmmnDetailCodeVO searchVO) throws Exception {
        return (Integer)select("CmmnDetailCodeManageDAO.selectCmmnDetailCodeListAdminTotCnt", searchVO);
    }
	/**
	 * 공통상세코드를 수정한다.
	 * @param cmmnDetailCode

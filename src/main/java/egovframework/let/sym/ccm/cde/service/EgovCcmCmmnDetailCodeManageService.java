...
public interface EgovCcmCmmnDetailCodeManageService {
	...
	void deleteCmmnDetailCodePhysic(CmmnDetailCode cmmnDetailCode) throws Exception;
	...
	List<?> selectCmmnDetailCodeListAdmin(CmmnDetailCodeVO searchVO) throws Exception;
    /**
	 * 공통상세코드 총 갯수를 조회한다.
     * @param searchVO
    ...
    int selectCmmnDetailCodeListAdminTotCnt(CmmnDetailCodeVO searchVO) throws Exception;

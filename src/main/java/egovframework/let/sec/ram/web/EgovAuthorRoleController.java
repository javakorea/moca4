...
public class EgovAuthorRoleController {
    ...
    @RequestMapping(value="/sec/ram/EgovAuthorRoleList_json.do")
	public View EgovAuthorRoleList_json(@ModelAttribute("authorRoleManageVO") AuthorRoleManageVO authorRoleManageVO,
		...
		authorRoleManageVO.setLastIndex(9999);
		authorRoleManageVO.setRecordCountPerPage(999);
		authorRoleManageVO.setSearchKeyword(searchKeyword);
        model.addAttribute("list", egovAuthorRoleManageService.selectAuthorRoleList(authorRoleManageVO));
        //model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
        return jsonview;
	}
